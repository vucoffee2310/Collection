...
import { simulateSSEStream, StreamingTranslationProcessor } from '../stream.js';
...
import { createCleanJSON, createMinimalJSON, createStructuredJSON } from './export-clean.js';
import { createResultsCard } from './card.js';
import { createCardsContainer, updateCards } from './stream-cards.js';
...
export const createStreamModal = (track, getOrCreateJSON, processTrack) => {
  ...
  if (!document.querySelector('#streamCardsCSS')) {
    ...
    style.href = chrome.runtime.getURL('js/modules/ui/stream-cards.css');

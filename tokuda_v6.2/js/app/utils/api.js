/**
 * AI API Integration
 * Handles communication with Gemini AI for translation
 */
 ...
 * @param {string} content - Content to send to AI
...
/**
 * Get POT (Proof of Origin Token) from background script
 * @param {string} videoId - YouTube video ID
 * @returns {Promise<Object>} - POT response object
 */

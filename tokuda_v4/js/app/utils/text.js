 ...
 * Functions for text manipulation and marker handling
 */
 ...
 * @param {string} text - Input text with paragraphs
 * @returns {string} - Text with merged paragraphs
 */
 ...
 * @returns {Object} - {before, after} split text
 */
export const splitTextAtMiddle = (text, lang) => {
  // Use grapheme segmentation for non-spaced languages
  ...
  // Fallback: split at space or character boundary

...
/**
 * Check if text has compound markers
 */
...
/**
 * Safely merge compounds - prevents double-wrapping
 * This is the PRIMARY function to use for compound merging
 */
export const safelyMergeCompounds = (text, force = false) => {
  ...
  const alreadyHasMarkers = text.includes(COMPOUND_OPEN) && text.includes(COMPOUND_CLOSE);
 ...
 * Internal function - use safelyMergeCompounds() instead
 */

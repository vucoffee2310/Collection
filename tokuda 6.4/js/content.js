 ...
 * ✅ UPDATED: Added message relay for AI Studio automation
 */
...
(async () => {
  ...
  // ✅ NEW: Listen for messages from background (AI Studio updates)
  chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
    // Relay AI Studio messages to the page (modal)
    if (request.action === 'aiStudioUpdate' || 
      ...
      // Dispatch custom event to the page so modal can listen

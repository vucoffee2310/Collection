...
namespace com.edc.classbook.util.codec.language.bm
{
	...
	internal sealed class Rule$7 : Object, Rule.RPattern
	{
		// Token: 0x060002AE RID: 686 RVA: 0x0001044C File Offset: 0x0000E64C
		[LineNumberTable(474)]
		[MethodImpl(8)]
		internal Rule$7(string A_1, bool A_2)
		{
		}

		// Token: 0x060002AF RID: 687 RVA: 0x00010474 File Offset: 0x0000E674
		[LineNumberTable(477)]
		[MethodImpl(8)]

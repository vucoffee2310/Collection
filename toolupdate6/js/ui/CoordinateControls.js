...
export class CoordinateControls {
  ...
  _handleReload(pageNum, stateManager, renderCallback) {
    ...
    state.orderingIndex =
      (state.orderingIndex + 1) % CONFIG.COORDINATE_ORDERINGS.length;
    ...
    document
      .querySelector(`#page-wrapper-${pageNum} .page-coord-controls`)
      ?.classList.add("preview-active");
    document
      .querySelector(`#page-wrapper-${pageNum}`)

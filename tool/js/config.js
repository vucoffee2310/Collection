export const CONFIG = {
    ...
    COLOR_PALETTES: {
        ...
        highContrast: { 
            ...
            background: [255, 241, 118], 
            text: [21, 21, 21], 
            border: [253, 216, 53] 
        },
        classicSoft: { 
            name: "Classic (Soft White)", 
        ...
        softPeach: { 
            name: "Soft Peach (Dyslexia Friendly)", 
            background: [253, 228, 201], 
            text: [85, 53, 33], 
            border: [240, 210, 180] 
        },
        nightReader: { 
            name: "Night Reader (Dark Mode)", 
            background: [21, 21, 21], 
            text: [220, 220, 220], 
            border: [50, 50, 50] 
        }
    },
    DEFAULT_PALETTE: 'modernDark'
};

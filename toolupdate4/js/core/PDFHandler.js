...
export class PDFHandler {
  ...
  async renderPageToCanvas(wrapper, pageNum, scale) {
    ...
    try {
      ...
      // HIGH RESOLUTION internal canvas (fixed for quality)
      canvas.width = Math.round(viewport.width);
      canvas.height = Math.round(viewport.height);
      
      // CSS: Fill wrapper completely (responsive)
      ...
      wrapper.dataset.canvasWidth = canvas.width;
      wrapper.dataset.canvasHeight = canvas.height;

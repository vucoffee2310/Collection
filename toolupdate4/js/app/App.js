...
import { readFile, withErrorHandling, createButtonHandler, forceUIUpdate, debounce } from '../utils.js';
...
export class PDFOverlayApp {
  ...
  _setupResizeHandler() {
    // Recalculate font sizes when window resizes
  ...
  async render() {
    ...
    pages.forEach((page, i) => {
      ...
      this.pdf.queuePageForRender(wrapper, async () => {
        ...
        // Wait for wrapper to have actual dimensions before rendering overlays
